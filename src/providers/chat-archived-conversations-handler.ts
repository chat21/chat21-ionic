...
export class ChatArchivedConversationsHandler {
    ...
    added(childSnapshot){
        ...
        // console.log("ChatArchivedConversationsHandler::added::clone::clone.size", clone.length);
        // console.log("ChatArchivedConversationsHandler::added::clone::conversations.size", this.conversations.length);
        // clone.splice(0, 0, conversation);       
        // for (var i = 0; i < clone.length; i++) {
        //     var item: ConversationModel = clone[i];
        //     console.log(i + ") ChatArchivedConversationsHandler::added::clone::item", item, item.timestamp);
        // }
        // this.conversations = clone;
        // for (var i = 0; i < this.conversations.length; i++) {
        //     var item: ConversationModel = this.conversations[i];
        //     console.log(i + ") ChatArchivedConversationsHandler::added::clone::conversation", item, item.timestamp);
        // } 
    }
    /**
    ...
    removed(childSnapshot){
        ...
        //     console.log(i + ") ChatArchivedConversationsHandler::removed::item", item, item.timestamp);
        // }
